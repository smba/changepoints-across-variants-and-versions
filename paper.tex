...
\begin{document}
	...
	\begin{table}
		...
		\begin{tabular}{llr}
			...
			\midrule
			\parbox[t]{20mm}{\multirow{4}{*}{\rotatebox[origin=c]{0}{\parbox{2cm}{\centering Synthesized Systems}}}} & $n_\text{options}$                & 8, 16, 32, 64                \\
			& $n_\text{commits}$                & 1000, 2500                \\
			& $n_\text{changepoints}$           & 1, 2, 5, 10                        \\
			& $p_\text{interaction}$ & 0.5, 0.7, 0.9                     \\
			\midrule
			\parbox[t]{20mm}{\multirow{2}{*}{\rotatebox[origin=c]{0}{\parbox{2cm}{\centering Initialization}}}}   & $N_\text{initial}$       & 2, 5, 10                           \\
